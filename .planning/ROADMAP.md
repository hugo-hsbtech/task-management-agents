...
**Plans**: 5 plans
Plans:
- [x] 02-01-PLAN.md — Wave 0 test scaffolds + per-agent CLI module skeletons + hsb-test-fixture checkpoint (covers all 19 requirement IDs as test stubs)
- [x] 02-02-PLAN.md — Backlog Agent: contracts + agent + SKILL.md + CLI + integration tests — BKPK-01..05
- [x] 02-03-PLAN.md — Builder Agent: contracts + agent + SKILL.md + CLI + integration tests — BLDR-01..04
- [x] 02-04-PLAN.md — Git Agent: contracts + agent + SKILL.md + CLI (create-pr, rebase-stack) + integration tests — GITA-01..05
- [x] 02-05-PLAN.md — QA Agent: contracts (with IMMUTABLE cycle cap validator) + agent + SKILL.md + CLI + integration tests — QAAG-01..05
