...
3. **Set up the remote and worktree**:
   ...
   - If not, add it: `git remote add USERNAME git@github.com:USERNAME/mono-ezra`
   - Fetch from the remote: `git fetch USERNAME`
   - Create worktree: `git worktree add -b BRANCHNAME ~/wt/mono-ezra/SHORT_NAME USERNAME/BRANCHNAME`
...
```
/ezra-local-review samdickson22:sam/eng-1696-hotkey-for-yolo-mode
```

This will:

- Add 'samdickson22' as a remote
- Create worktree at `~/wt/mono-ezra/eng-1696`
