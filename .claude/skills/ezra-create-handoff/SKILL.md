...
- Create your file under `docs/handoffs/ENG-XXXX/YYYY-MM-DD_HH-MM-SS_ENG-ZZZZ_description.md`, where:
...
- Gather metadata for the YAML frontmatter using these commands:
  - Git commit: `git rev-parse HEAD`
  - Branch: `git branch --show-current`
  - Repository: basename of the repo root directory
  - Date: current date/time in ISO format with timezone
- Examples:
