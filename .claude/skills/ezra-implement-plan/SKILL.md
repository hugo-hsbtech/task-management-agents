...
- **Test generation**: If the plan's Testing Strategy includes test plans for source files implemented in this phase, run `/ezra-generate-<backend/frontend>-tests <source-file>` for each. Enter healing loop if tests fail.
