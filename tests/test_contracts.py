...
from hsb.contracts.base import ErrorContract, RuntimeEnvelope
        ...
        (
            {
                ...
                "result": "success",
                "linear_entities": [
                    {"id": "LIN-1", "type": "task", "url": "https://gitlab.com/x"}
                ],
                "error": None,
            },
            "wrong_url_domain_rejected",
        ),
